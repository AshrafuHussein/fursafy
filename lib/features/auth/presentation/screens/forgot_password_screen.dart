  ...
  Widget _formView() {
    return Column(
      ...
      children: [
        ...
        // Brand
        Text('Fursafy', style: FursafyTheme.headlineStyle.copyWith(
        ...
        RichText(text: TextSpan(
          ...
          children: [
            ...
            TextSpan(text: 'professional journey.',
        ...
        Text(
          ...
          style: FursafyTheme.bodyStyle.copyWith(
            fontSize: 16, color: FursafyTheme.onSurfaceVariant,
            height: 1.6),
        ),
        const SizedBox(height: 40),

        // Phone Field
        Text('PHONE NUMBER', style: FursafyTheme.labelStyle.copyWith(
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.smartphone, color: FursafyTheme.outline, size: 20),
              hintText: '+255 --- --- ---',
              hintStyle: FursafyTheme.bodyStyle.copyWith(color: FursafyTheme.outline),
            ),
          ),
        ),
          ...
          child: ElevatedButton(
            ...
            child: _sending
                ...
                : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text('Send Code', style: FursafyTheme.bodyStyle.copyWith(
        ...
        Center(child: GestureDetector(
          ...
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            Icon(Icons.chevron_left, size: 18, color: FursafyTheme.primary),
            const SizedBox(width: 4),
            Text('Back to sign in', style: FursafyTheme.bodyStyle.copyWith(
              fontWeight: FontWeight.w700, color: FursafyTheme.primary)),
          ]),
        )),
        const SizedBox(height: 32),
      ],
    ...
    return Center(child: Column(
      ...
      children: [
        Container(
          width: 80, height: 80,
          decoration: BoxDecoration(
            color: FursafyTheme.primaryFixed, shape: BoxShape.circle),
          child: const Icon(Icons.check, color: FursafyTheme.primary, size: 40),
        ),
        const SizedBox(height: 32),
        Text('Code Sent!', style: FursafyTheme.headlineStyle.copyWith(
        ...
        SizedBox(height: 52, width: double.infinity,
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(100))),
            child: Text('Return to Login', style: FursafyTheme.bodyStyle.copyWith(
