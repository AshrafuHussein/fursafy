...
class _ProviderRatingScreenState extends State<ProviderRatingScreen> {
  ...
  final _ratingLabels = ['', 'Poor', 'Fair', 'Good', 'Very Good!', 'Excellent!'];
      ...
      body: _loading
          ...
          : SingleChildScrollView(
              ...
              child: Column(children: [
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      child: Center(child: Text(
                        _youthName.isNotEmpty ? _youthName[0].toUpperCase() : '?',
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        Text('COMPLETED PROJECT', style: FursafyTheme.labelStyle.copyWith(
                          fontSize: 10, fontWeight: FontWeight.w600,
                          letterSpacing: 1.5, color: FursafyTheme.secondary)),
                        const SizedBox(height: 4),
                        Text('Rate $_youthName\'s Performance',
                          style: FursafyTheme.headlineStyle.copyWith(
                            fontSize: 18, fontWeight: FontWeight.w700)),
                        Text(_jobTitle, style: FursafyTheme.bodyStyle.copyWith(
                ...
                // Rating section
                Text('Overall Experience', style: FursafyTheme.headlineStyle.copyWith(
                  fontSize: 22, fontWeight: FontWeight.w700)),
                const SizedBox(height: 8),
                Text('Tap the stars to rate your experience with $_youthName',
                    ...
                    child: SizedBox(width: 56, height: 56,
                      child: Icon(
                        ...
                        color: i < _score
                            ...
                            : FursafyTheme.outlineVariant.withValues(alpha: 0.4),
                      )),
                  )),
                ),
                ...
                Container(
                  ...
                  child: Text(_ratingLabels[_score],
                ...
                Align(alignment: Alignment.centerLeft,
                  child: Text('How was $_youthName\'s performance on this job?',
                    style: FursafyTheme.headlineStyle.copyWith(
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Share details about the work quality, communication, and timeliness...',
                      hintStyle: FursafyTheme.bodyStyle.copyWith(
                        color: FursafyTheme.onSurfaceVariant.withValues(alpha: 0.5), fontSize: 14),
                    ),
                    style: FursafyTheme.bodyStyle.copyWith(
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(100)),
                        child: Text(t, style: FursafyTheme.bodyStyle.copyWith(
                          fontSize: 14, fontWeight: FontWeight.w500,
                          color: sel ? FursafyTheme.onPrimary : FursafyTheme.onSurface)),
                      ),
                    );
                  }).toList()),
                  ...
                  child: ElevatedButton(
                    ...
                    child: _submitting
                        ...
                        : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Text('Submit Review', style: FursafyTheme.headlineStyle.copyWith(
                ...
                const SizedBox(height: 8),
                Text('Your review will be public on ${_youthName}\'s profile',
                  style: FursafyTheme.labelStyle.copyWith(
