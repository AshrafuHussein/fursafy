        ...
        children: [
            ...
            children: [
              ...job.skillsRequired
                  ...
                  .map(
                    (s) => _chip(
                      s,
                      bg: FursafyTheme.primaryFixed,
                      fg: FursafyTheme.onPrimaryFixed,
                    ),
                  ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                child: _bentoStat('POSTED', timeago.format(job.createdAt)),
              ),
            ],
          ),
          const SizedBox(height: 28),
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    disabledBackgroundColor: _hasApplied
                        ? FursafyTheme.surfaceContainerHighest
                        : null,
                    disabledForegroundColor: _hasApplied
                        ? FursafyTheme.onSurfaceVariant
                        : null,
                    backgroundColor: FursafyTheme.primary,
                    foregroundColor: FursafyTheme.onPrimary,
